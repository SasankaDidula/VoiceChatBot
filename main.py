...
def audio():
    ...
    res = requests.post('http://127.0.0.1:5000/news_urls', data = request.data)
    file = "tmp/audio.wav" #r"C:\Users\USER\Desktop\audio_gui-master\tmp\audio.wav"
    output = "No Recording!!!"
    if file:
            r = sr.Recognizer()
